...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="page-header d-flex justify-content-between align-items-center flex-wrap">
            <div>
                <h2 class="mb-2 fw-bold">📅 Today's Wholesaler Orders</h2>
                <p class="mb-0 text-white-80">Orders placed today ({{ \Carbon\Carbon::today()->format('M d, Y') }})</p>
            </div>
                ...
                <div class="stats-card">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="stats-value">{{ number_format($todayCount) }}</div>
                        </div>
                        <div class="bg-yellow-100 p-3 rounded">
                            <i class="material-icons-outlined text-yellow-600" style="font-size: 2rem;">today</i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        @else
            ...
            <div class="card">
                <div class="card-body text-center py-5">
                    <i class="material-icons-outlined mb-3" style="font-size: 4rem; color: #94a3b8;">today</i>
                    <h4 class="mb-2">No Orders Today</h4>
                    <p class="text-muted mb-4">No wholesaler orders have been placed today.</p>
