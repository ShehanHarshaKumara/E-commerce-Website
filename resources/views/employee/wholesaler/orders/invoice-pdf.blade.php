...
<head>
    ...
    <style>
        ...
        .status-processing { background: #f3e8ff; color: #6d28d9; }
...
<div class="invoice-container">
    ...
    <div class="invoice-header">
        <div class="company-info">
            <h1>{{ $order->wholesaler->business_name ?? 'Wholesale Business' }}</h1>
            <p>
                {{ $order->wholesaler->address ?? '' }}<br>
                Phone: {{ $order->wholesaler->phone ?? '' }}<br>
                Email: {{ $order->wholesaler->email ?? '' }}
            </p>
        </div>
