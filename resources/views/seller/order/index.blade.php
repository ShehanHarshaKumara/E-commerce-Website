        ...
        <div class="container">
            ...
            <div class="section-header">
                ...
                <div class="d-flex gap-3">
                    <a href="{{ route('seller.order.export') }}" class="btn btn-outline-primary btn-export">
            ...
            <div class="orders-table">
                <div class="table-header">
                    ...
                    <form action="{{ route('seller.orders.index') }}" method="GET" class="search-box">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            ...
                                            <a href="{{ route('seller.orders.invoice.download', $order->id) }}"
                                               class="action-btn"
