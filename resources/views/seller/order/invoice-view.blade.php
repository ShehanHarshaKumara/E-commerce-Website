        ...
        <div class="invoice-paper">
            ...
            <div class="invoice-header">
                <div class="company-info">
                    <h1>{{ auth()->guard('seller')->user()->business_name ?? 'Seller Business' }}</h1>
                    <div class="contact-info">
                        <p>
                            <i class="fas fa-map-marker-alt me-2"></i>
                            {{ auth()->guard('seller')->user()->address ?? '123 Business Street, City' }}
                        </p>
                        <p>
                            <i class="fas fa-phone me-2"></i>
                            {{ auth()->guard('seller')->user()->phone ?? '+123 456 7890' }}
                        </p>
                        <p>
                            <i class="fas fa-envelope me-2"></i>
                            {{ auth()->guard('seller')->user()->email ?? 'info@business.com' }}
                        </p>
                    </div>
                </div>
            ...
            <div class="invoice-actions">
                ...
                <a href="{{ route('seller.orders.invoice.download', $order->id) }}" class="btn-print">
                    <i class="fas fa-download me-2"></i>
                    Download PDF
                </a>
                <a href="{{ route('seller.orders.show', $order->id) }}" class="btn btn-outline-primary">
