...
@section('content')
    <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-start">
                    <div class="flex-grow-1">
                        <h4 class="fw-bold mb-3 d-flex align-items-center">
                            <span class="material-icons me-3" style="font-size: 2rem; color: var(--primary);">edit</span>
                            Edit Product: {{ $product->name }}
                        </h4>
                        <div class="d-flex flex-wrap align-items-center gap-3 mb-2">
                            <span class="d-flex align-items-center" style="color: var(--gray-600);">
                                <span class="material-icons me-2" style="font-size: 1.2rem; color: var(--primary);">qr_code</span>
                                <strong>Code:</strong> {{ $product->code }}
                            </span>
                            <span class="d-flex align-items-center" style="color: var(--gray-600);">
                                <span class="material-icons me-2" style="font-size: 1.2rem; color: var(--primary);">category</span>
                                <strong>Type:</strong> {{ ucfirst($product->type) }}
                            </span>
                            <span class="d-flex align-items-center" style="color: var(--gray-600);">
                                <span class="material-icons me-2" style="font-size: 1.2rem; color: var(--primary);">inventory</span>
                        ...
                        <p class="mb-0 opacity-90 d-flex align-items-center" style="max-width: 600px; color: var(--gray-600);">
                            <span class="material-icons me-2" style="font-size: 1.2rem; color: var(--primary);">update</span>
                            Update product details and inventory with our smart editing interface
                        </p>
                    </div>
        ...
        <div class="alert-container">
            ...
            @if($errors->any())
                <div class="alert alert-danger alert-dismissible fade show d-flex align-items-center" role="alert">
                    <span class="material-icons me-3" style="font-size: 2rem; color: var(--danger);">error</span>
                    <div class="flex-grow-1">
                        <h6 class="mb-2" style="color: var(--gray-800);">Please fix the following errors:</h6>
                        <ul class="mb-0" style="color: var(--gray-700); padding-left: 1rem;">
        ...
        <!-- Main Form -->
        <form id="productForm" action="{{ route('seller.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                    ...
                    <div class="form-section-card active" data-step="1">
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p>Update basic details about your product</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="info-text mt-2 d-flex align-items-center">
                                    ...
                                    <span>Product code cannot be changed</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="original-value">
                                    <strong>Original:</strong> {{ $product->name }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                        ...
                                        <option value="stock_item" {{ old('type', $product->type) == 'stock_item' ? 'selected' : '' }}>Stock Item</option>
                            ...
                            <div class="col-12 mb-4">
                                <label class="form-label">
                                    ...
                                    Description
                                    <span class="char-count ms-2" id="descriptionCount">{{ strlen($product->description) }}/2000</span>
                                </label>
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                          rows="5" placeholder="Enter detailed product description..."
                                          maxlength="2000" id="descriptionInput">{{ old('description', $product->description) }}</textarea>
                                @error('description')
                                <div class="invalid-feedback d-flex align-items-center mt-2">
                                    <span class="material-icons me-1" style="font-size: 1rem;">error</span>
                                    {{ $message }}
                            ...
                            <div class="col-12 mb-4">
                                <label class="form-label">
                                    ...
                                    Key Features
                                    <span class="char-count ms-2" id="featuresCount">{{ strlen($product->features) }}/2000</span>
                                </label>
                                <textarea name="features" class="form-control @error('features') is-invalid @enderror"
                                          ...
                                          maxlength="2000" id="featuresInput">{{ old('features', $product->features) }}</textarea>
                                <div class="info-text mt-2 d-flex align-items-center">
                    ...
                    <div class="form-section-card" data-step="2">
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p>Update product images (Current image will be replaced)</p>
                            </div>
                        </div>
                        ...
                        @if($product->img)
                            <div class="mb-4">
                                ...
                                <div class="info-text mt-2 d-flex align-items-center">
                                    <span class="material-icons me-1" style="font-size: 1rem;">warning</span>
                                    <span>Click the X icon to remove current image and upload new one</span>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="upload-container">
                            <div class="upload-area" id="uploadTrigger">
                                ...
                                <h4 class="mt-3 mb-2" style="color: var(--gray-800);">Drag & Drop New Image Here</h4>
                                <p class="text-muted mb-3">or click to browse files</p>
                                <p class="text-muted small">Supports JPG, PNG, GIF, WEBP - Max 2MB per image</p>
                                <input type="file" name="img" id="imageInput" class="d-none" accept="image/*">
                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-section-card" data-step="3">
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p>Update pricing for your product</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="stock_price" id="stockPrice"
                                       ...
                                       step="0.01" min="0" value="{{ old('stock_price', $product->stock_price) }}" placeholder="0.00" required>
                            </div>
                            @error('stock_price')
                            <div class="invalid-feedback d-flex align-items-center mt-2">
                                <span class="material-icons me-1" style="font-size: 1rem;">error</span>
                            ...
                            @enderror
                            <div class="original-value">
                                <strong>Original:</strong> Rs. {{ number_format($product->stock_price, 2) }}
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="display_price" id="displayPrice"
                                       ...
                                       step="0.01" min="0" value="{{ old('display_price', $product->display_price) }}" placeholder="0.00" required>
                            </div>
                            @error('display_price')
                            <div class="invalid-feedback d-flex align-items-center mt-2">
                                <span class="material-icons me-1" style="font-size: 1rem;">error</span>
                            ...
                            @enderror
                            <div class="original-value">
                                <strong>Original:</strong> Rs. {{ number_format($product->display_price, 2) }}
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="discount" id="discount"
                                       ...
                                       step="0.01" min="0" max="100" value="{{ old('discount', $product->discount) }}" placeholder="0">
                            </div>
                            @error('discount')
                            <div class="invalid-feedback d-flex align-items-center mt-2">
                                <span class="material-icons me-1" style="font-size: 1rem;">error</span>
                            ...
                            @enderror
                            <div class="original-value">
                                <strong>Original:</strong> {{ $product->discount }}%
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="packaging_cost" id="packagingCost"
                                       ...
                                       step="0.01" min="0" value="{{ old('packaging_cost', $product->packaging_cost) }}" placeholder="0.00">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="qty" id="quantity"
                                       ...
                                       min="0" value="{{ old('qty', $product->qty) }}" placeholder="0" required>
                            </div>
                            @error('qty')
                            <div class="invalid-feedback d-flex align-items-center mt-2">
                                <span class="material-icons me-1" style="font-size: 1rem;">error</span>
                            ...
                            @enderror
                            <div class="original-value">
                                <strong>Original:</strong> {{ $product->qty }} units
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="min_qty"
                                       ...
                                       min="1" value="{{ old('min_qty', $product->min_qty) }}" placeholder="1" required>
                            </div>
                            <div class="info-text mt-2 d-flex align-items-center">
                            ...
                            @enderror
                            <div class="original-value">
                                <strong>Original:</strong> {{ $product->min_qty }} units
                            </div>
                        </div>
                    ...
                    <div class="form-section-card" data-step="5">
                        <div class="section-header">
                            ...
                            <div>
                                <h5 class="mb-1">Review & Update</h5>
                                <p>Finalize and update your product</p>
                            </div>
                        </div>
                        ...
                        <div class="review-summary mb-4">
                            ...
                            <div class="list-group">
                                <div class="list-group-item border-0 px-0 py-2 d-flex align-items-center">
                                    <span class="material-icons me-3" style="color: var(--info);">qr_code</span>
                                    <div>
                                        <small class="text-muted">Product Code</small>
                                        <p class="mb-0 fw-bold" style="color: var(--gray-800);">{{ $product->code }}</p>
                                    </div>
                                </div>
                                <div class="list-group-item border-0 px-0 py-2 d-flex align-items-center">
                                    <span class="material-icons me-3" style="color: var(--primary);">inventory_2</span>
                                    <div>
                                        <small class="text-muted">Updated Name</small>
                                        <p class="mb-0 fw-bold" style="color: var(--gray-800);" id="reviewName">{{ $product->name }}</p>
                                    </div>
                                </div>
                                <div class="list-group-item border-0 px-0 py-2 d-flex align-items-center">
                                    <span class="material-icons me-3" style="color: var(--warning);">payments</span>
                                    <div>
                                        <small class="text-muted">Updated Price</small>
                                        <p class="mb-0 fw-bold" style="color: var(--gray-800);" id="reviewPrice">Rs. {{ number_format($product->display_price, 2) }}</p>
                                    </div>
                                </div>
                                <div class="list-group-item border-0 px-0 py-2 d-flex align-items-center">
                                    <span class="material-icons me-3" style="color: var(--success);">inventory</span>
                                    <div>
                                        <small class="text-muted">Updated Stock</small>
                                        <p class="mb-0 fw-bold" style="color: var(--gray-800);" id="reviewStock">{{ $product->qty }} units</p>
                                    </div>
                                </div>
                                <div class="list-group-item border-0 px-0 py-2 d-flex align-items-center">
                                    <span class="material-icons me-3" style="color: var(--danger);">history</span>
                                    <div>
                                        <small class="text-muted">Last Updated</small>
                                        <p class="mb-0 fw-bold" style="color: var(--gray-800);">{{ $product->updated_at->format('M d, Y H:i') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('seller.product.show', $product->id) }}" class="btn btn-outline-primary btn-action">
                                <span class="material-icons">visibility</span>
                                View Product
                            </a>
                        </div>
    ...
    <div class="floating-actions">
        ...
        <button class="floating-btn warning" onclick="showOriginalValues()" title="Show Original Values">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateReviewSummary() {
                ...
                if (quantity && quantity.value) {
                    ...
                    reviewStock.textContent = '{{ $product->qty }} units';
                }
            }
                ...
                reader.onload = function(e) {
                    previewContainer.innerHTML = `
                        <div class="preview-card">
                            ...
                            <div class="remove-image" onclick="removeNewImagePreview()">
                                <span class="material-icons">close</span>
                            </div>
                            <div class="edit-mode-indicator" style="top: auto; bottom: 1rem; left: 1rem; right: auto; background: var(--success);">
                                <span class="material-icons me-1">new_releases</span>
                                New Image
                            </div>
                        </div>
                    `;
            ...
            // Global function for removing current image
            window.removeCurrentImage = function() {
                Swal.fire({
                    title: 'Remove Current Image?',
                    text: "Are you sure you want to remove the current product image?",
                    icon: 'warning',
            ...
            // Global function for removing new image preview
            window.removeNewImagePreview = function() {
                Swal.fire({
                    title: 'Remove New Image?',
                    text: "Are you sure you want to remove the newly uploaded image?",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#4f46e5',
                    cancelButtonColor: '#6c757d',
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    submitBtn.innerHTML = '<span class="material-icons">hourglass_top</span> Processing Update...';
                    ...
                    fetch(form.action, {
                            ...
                            if (status) {
                                Swal.fire({
                                    ...
                                    <div class="text-center">
                                        <span class="material-icons" style="font-size: 4rem; color: var(--success);">check_circle</span>
                                        <h4 class="mt-3">${data.message}</h4>
                                        <p class="text-muted">Product has been successfully updated.</p>
                                    </div>
                                `,
                                    showConfirmButton: false,
                                    timer: 2000
                                }).then(() => {
                                    window.location.href = data.redirect || '{{ route('seller.product.index') }}';
                                });
                            } else {
                                throw data;
                            }
                        ...
                        .finally(() => {
                            ...
                            submitBtn.innerHTML = '<span class="material-icons">save</span> Update Product';
                        });
                });
            }
            ...
            window.showOriginalValues = function() {
                Swal.fire({
                    title: 'Original Product Values',
                    html: `
                        <div class="text-start">
                            <p><strong>Name:</strong> {{ $product->name }}</p>
                            <p><strong>Stock Price:</strong> Rs. {{ number_format($product->stock_price, 2) }}</p>
                            <p><strong>Display Price:</strong> Rs. {{ number_format($product->display_price, 2) }}</p>
                            <p><strong>Discount:</strong> {{ $product->discount }}%</p>
                            <p><strong>Stock Quantity:</strong> {{ $product->qty }} units</p>
                            <p><strong>Min Quantity:</strong> {{ $product->min_qty }} units</p>
                            <hr>
                            <p class="text-muted"><small>Last Updated: {{ $product->updated_at->format('M d, Y H:i') }}</small></p>
                        </div>
                    `,
                    icon: 'info',
                    confirmButtonColor: '#4f46e5'
