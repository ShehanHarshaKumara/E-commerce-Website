...
@section('content')
    ...
    <form action="{{ route('seller.category.edit', $category->id) }}" method="POST" enctype="multipart/form-data" id="categoryForm">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-end gap-3">
                    <a href="{{ route('seller.category.index') }}" class="btn btn-danger d-flex align-items-center">
