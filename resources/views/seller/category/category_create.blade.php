...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn mt-0">
            <a href="{{route('seller.category.index')}}" class="btn btn-secondary">View Category List</a>
        </div>
    </div>
    <form action="{{route('seller.category.store')}}" method="post" enctype="multipart/form-data"
            ...
            <div class="accordions-items-seperate" id="accordionSpacingExample">
                <div class="accordion-item border mb-4">
                    <h2 class="accordion-header " id="headingSpacingOne">
                        <div style="background-color: var(--main-theme-color) !important;"
                             class=" accordion-button bg-white" data-bs-toggle="collapse"
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-fill">
                                <h5 class="d-flex align-items-center">
                                    ...
                                    <span>Category Information</span></h5>
                            </div>
                        </div>
                    </h2>
                    <div id="SpacingOne">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="code" class="form-control" disabled value="{{$code}}">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="mb-3">
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12">
                    <button type="button" class="btn btn-danger " fdprocessedid="2bjap">Cancel</button>
