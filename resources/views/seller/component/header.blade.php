<style>
    /* Modern Header Styles for Seller - Fixed Position */
    .app-header {
    ...
    .sidebar.collapsed + .page-wrapper .app-header {
        left: var(--sidebar-collapsed-width);
        width: calc(100% - var(--sidebar-collapsed-width));
    }

    /* When on mobile, header should be full width */
    ...
    .dropdown-item:hover {
        background: linear-gradient(90deg, rgba(59, 130, 246, 0.08) 0%, rgba(37, 99, 235, 0.08) 100%) !important;
...
<header class="app-header">
    ...
    <div class="header-left">
        ...
        <a href="{{ route('seller.dashboard') }}" class="brand-logo">
            ...
            <small class="logo-badge">Seller</small>
        </a>
    </div>
    ...
    <div class="header-center">
        <div class="search-container">
            ...
            <input type="text" class="search-input" placeholder="Search orders, products, customers..." aria-label="Search">
        </div>
    </div>
    ...
    <div class="header-right">
        ...
        <div class="user-dropdown">
            <button class="user-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                @php
                    $seller = auth()->user();
                    $avatarUrl = $seller && $seller->img ? asset('storage/' . $seller->img) : asset('asset/img/default-avatar.png');
                @endphp
                <img src="{{ $avatarUrl }}"
                     alt="Seller Avatar"
                     class="user-avatar"
                ...
                <span class="user-name">
                    ...
                    <small>{{ ucfirst(str_replace('_', ' ', auth()->user()->type ?? 'Seller')) }}</small>
                </span>
                ...
                <div class="dropdown-header">
                    ...
                    <div class="profile-details">
                        ...
                        <div class="seller-type">
                            @if(auth()->user()->type)
                                {{ ucfirst(str_replace('_', ' ', auth()->user()->type)) }}
                            @else
                                Seller
                            @endif
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        // Adjust header width when sidebar toggles
        $(document).on('sidebarToggle', function(e) {
        ...
        // Scroll effect for header (optional cosmetic changes)
