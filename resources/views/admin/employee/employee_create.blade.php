...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn mt-0">
            <a href="{{route('employee.list')}}" class="btn btn-secondary">View Employee List</a>
        </div>
    </div>
    <form action="{{route('employee.store')}}" class="add-product-form" method="post" enctype="multipart/form-data">
        @csrf
                    ...
                    <h2 class="accordion-header " id="headingSpacingOne">
                            <div class="d-flex align-items-center justify-content-between flex-fill p-3">
                                <h5 class="d-flex align-items-center">
                                    ...
                                    <span>Employee Information</span></h5>
                            </div>
                    </h2>
                    <div id="SpacingOne">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="code" class="form-control" required  value="{{$code}}" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="mb-3">
