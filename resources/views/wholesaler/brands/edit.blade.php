...
@section('content')
    ...
    <form action="{{ route('wholesaler.brands.update', $brand->id) }}" method="post" enctype="multipart/form-data" id="brandForm">
        @csrf
        @method('PUT')
        ...
        <div class="form-card">
            ...
            <div class="mb-4">
                <label class="form-label d-flex align-items-center">
                    ...
                    {{ $brand->image ? 'Change Brand Image' : 'Upload Brand Image' }}
                </label>
