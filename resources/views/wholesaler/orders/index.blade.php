...
@push('title')
    All Orders | Wholesaler Dashboard
@endpush
        ...
        <div class="container">
            ...
            <div class="section-header">
                ...
                <div class="d-flex gap-3">
                    <a href="{{ route('wholesaler.orders.export') }}" class="btn btn-outline-primary btn-export">
            ...
            <div class="orders-stats">
                <div class="stat-card">
                    ...
                    <div class="stat-trend up">
                        ...
                        {{ $statusCounts['all'] > 0 ? 'Active' : 'No orders yet' }}
                    </div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-trend {{ $statusCounts['pending'] > 0 ? 'up' : '' }}">
            ...
            <div class="status-filter">
                <button class="status-btn {{ !request('status') ? 'active' : '' }}" onclick="filterOrders('all')">
            ...
            <div class="orders-table">
                <div class="table-header">
                    ...
                    <form action="{{ route('wholesaler.orders.index') }}" method="GET" class="search-box">
                                        ...
                                        <span class="status-badge status-{{ $order->status }}">
                                            <i class="material-icons-outlined">
                                                @switch($order->status)
                                                    ...
                                                    @case('processing') settings @break
                    ...
                    @else
                        <div class="empty-state">
                            <div class="empty-icon">
                                <i class="material-icons-outlined" style="font-size: 64px;">shopping_bag</i>
                            </div>
                            ...
                            @if(request('search') || request('status'))
                                <a href="{{ route('wholesaler.orders.index') }}" class="btn btn-primary">
