            ...
            <div class="category-details-card">
                ...
                <div class="mt-4 pt-3 border-top">
                    <div class="btn-group">
                        ...
                        <a href="{{ route('wholesaler.categories.index') }}"
            ...
            <div class="category-details-card">
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        <strong>Rs. {{ number_format($product->display_price, 2) }}</strong>
                                        <br>
                                        <small class="text-muted">Wholesale: Rs. {{ number_format($product->wholesale_price, 2) }}</small>
                                    </td>
                                    <td>
                                            <span class="badge {{ $product->qty > 10 ? 'bg-success' : 'bg-danger' }}">
                                                {{ $product->qty }}
                                            </span>
                                    </td>
                                    <td>
                ...
                @else
                    <div class="empty-state">
                        ...
                        <a href="{{ route('wholesaler.products.create') }}" class="btn btn-primary mt-2">
